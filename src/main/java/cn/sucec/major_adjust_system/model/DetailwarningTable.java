...
public class DetailwarningTable {
	
	private Integer warningYear;// 被评为预警的年份
	private String majorCode; // 预警专业代码
	private String majorName; // 预警专业名称
	...
	public String toString() {
		return "DetailwarningTable [warningYear=" + warningYear + ", majorCode=" + majorCode + ", majorName="
				+ majorName + ", enrollmentYear=" + enrollmentYear + ", continuousEnrollment=" + continuousEnrollment
				+ ", years=" + years + ", art=" + art + ", provinceWarning=" + provinceWarning + ", schoolWarning="
				+ schoolWarning + ", lastAdjustment=" + lastAdjustment + ", thisAdjustment=" + thisAdjustment
				+ ", lastTransfer=" + lastTransfer + ", middleTransfer=" + middleTransfer + ", thisTransfer="
				+ thisTransfer + ", highStudentNumber=" + highStudentNumber + ", lowStudentNumber=" + lowStudentNumber
				+ ", firstEmploymentRate=" + firstEmploymentRate + ", secondEmploymentRate=" + secondEmploymentRate
				+ ", currentPosrgraduteRate=" + currentPosrgraduteRate + ", warningReason=" + warningReason + "]";
	}
	
	public DetailwarningTable() {
		super();
	}
	
	public DetailwarningTable(Integer warningYear, String majorCode, String majorName, Integer enrollmentYear,
			...
			Double secondEmploymentRate, Double currentPosrgraduteRate, String warningReason) {
		super();
		this.warningYear = warningYear;
		this.majorCode = majorCode;
		this.majorName = majorName;
